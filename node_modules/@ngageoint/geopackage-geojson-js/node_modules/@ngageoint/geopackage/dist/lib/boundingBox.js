...
var BoundingBox = /** @class */ (function () {
    ...
    BoundingBox.prototype.projectBoundingBox = function (from, to) {
        ...
        if (from && from !== 'undefined' && to && to !== 'undefined') {
            if (!projection_1.Projection.isConverter(to) && to.toUpperCase() === projectionConstants_1.ProjectionConstants.EPSG_3857 && !projection_1.Projection.isConverter(from) && from.toUpperCase() === projectionConstants_1.ProjectionConstants.EPSG_4326) {
